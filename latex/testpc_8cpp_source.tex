...
00033     QImage * retImage = model->\hyperlink{class_model_p_c_a6f191f62d4635d0d3555fcc0be298794}{encrypt}(data, &rImage, mode, key, bitsUsed, &error1);
00034     \textcolor{comment}{// De-embedding}
00035     QByteArray output = model->\hyperlink{class_model_p_c_a5995215a34a1e1f504035715a8013809}{decrypt}(retImage, key, mode, &error2);
00036 

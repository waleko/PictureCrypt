...
/*!
 * \brief The QAESEncryption class Small and portable AES encryption class for Qt.
 * Supports all key sizes - 128/192/256 bits - ECB, CBC, CFB and OFB modes.
 * Class made entirely by bricke.
 * Github: https://github.com/bricke/Qt-AES
 * \author Bricke (Matteo B)
 */
...
public:
    ...
    /*!
     * \brief The Padding enum Padding
    ...
    /*!
     * \brief Crypt Static encode function
     * \param level AES level of encryption
     * \param mode AES mode
     * \param rawText Input data
     * \param key Key for encrytion
     * \param iv IV vector
     * \param padding Padding
     * \return Returns encrypted data
     * \sa QAESEncryption::encode, QAESEncryption::Decrypt
     */
    ...
    /*!
     * \brief Decrypt Static decode function
     * \param level AES level of encryption
     * \param mode AES mode
     * \param rawText Encrypted data
     * \param key Key for encrytion
     * \param iv IV vector
     * \param padding Padding
     * \return Returns Decrypted data
     * \sa QAESEncryption::decode, QAESEncryption::Crypt
     */
    static QByteArray Decrypt(QAESEncryption::Aes level, QAESEncryption::Mode mode, const QByteArray &rawText, const QByteArray &key,
                              const QByteArray &iv = NULL, QAESEncryption::Padding padding = QAESEncryption::ISO);
    /*!
     * \brief ExpandKey Expands the key
     * \param level AES level
     * \param mode AES Mode
     * \param key key
     * \return Returns expanded key (I guess)
     * \sa QAESEncryption::expandKey
     */
    static QByteArray ExpandKey(QAESEncryption::Aes level, QAESEncryption::Mode mode, const QByteArray &key);
    /*!
     * \brief RemovePadding Removes padding
     * \param rawText Input data
     * \param padding Padding
     * \return Returns data with removed padding (I guess)
     * \sa QAESEncryption::removePadding
     */
    ...
    /*!
     * \brief encode Encodes data with AES
     * \note Basically the non-static method of QAESEncryption::Crypt
     *
     * \param rawText Input data
     * \param key Key
     * \param iv IV vector
     * \return Returns encoded data
     * \sa QAESEncryption::Crypt, QAESEncryption::decode
     */
    QByteArray encode(const QByteArray &rawText, const QByteArray &key, const QByteArray &iv = NULL);
    /*!
     * \brief decode Decodes data with AES
     * \note Basically the non-static method of QAESEncryption::Decrypt
     *
     * \param rawText Input data
     * \param key Key
     * \param iv IV vector
     * \return Returns decoded data
     * \sa QAESEncryption::Decrypt, QAESEncryption::encode
     */
    QByteArray decode(const QByteArray &rawText, const QByteArray &key, const QByteArray &iv = NULL);
    /*!
     * \brief RemovePadding Removes padding
     * \note Basically the non-static method of QAESEncryption::RemovePadding
     *
     * \param rawText Input data
     * \return Returns data with removed padding (I guess)
     * \sa QAESEncryption::RemovePadding
    ...
    /*!
     * \brief ExpandKey Expands the key
     * \note Basically the non-static method of QAESEncryption::ExpandKey
     *
     * \param key key
     * \return Returns expanded key (I guess)
     * \sa QAESEncryption::ExpandKey

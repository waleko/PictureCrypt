...
ModelPC::ModelPC(long _version)
{
    ...
    QProcess proc(this);
    proc.start("C:/Users/salex/Desktop/Debug/ConsoleApplication6.exe");
    proc.waitForStarted();
    bool wr = proc.isWritable();
    proc.write("qt tested!\n");
...
void ModelPC::jphs(QImage *image, QByteArray *data)
{
    ...
    {
        alert("JPHS not installed, installation required!", true);
        return;
    }
